export const siteContent = {
  ...
  hero: {
    ...
    creditPrefix: 'By',
    handle: '@lexylamps',
    handleUrl: 'https://www.instagram.com/lexylamps?igsh=MW00OTR6NG82b2RhOA%3D%3D&utm_source=qr',
  },
  about: {
    name: 'Alexia Lamparelli',
    portraitImage: '/assets/Alexia-Headshot.jpg',
    text: [
  ...
  canvaProjects: [
    {
      ...
      description: 'A polished identity concept exploring logo direction, color, and brand presentation for a clean, memorable visual system.',
      image: '/assets/Canva/canva-work-3.png',
      imageLabel: 'Featured Canva design',
      links: [
        { label: 'Design 01', href: 'https://www.canva.com/design/DAFGI4Fe9Ds/pb27FvDgPlzrZBLbNt55Gw/edit?utm_content=DAFGI4Fe9Ds&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton' },
      ],
    },
    {
      title: 'Logo & Brand Design',
      category: 'Content System',
      description: 'A structured branded layout system designed for reusable content, easy storytelling, and cohesive social presentation.',
      image: '/assets/Canva/canva-work-5.png',
      imageLabel: 'Carousel & story layouts',
      links: [
        { label: 'Design 02', href: 'https://www.canva.com/design/DAE9rmT2XhE/GdCD5fpdH0zPxIxliYbKIA/edit?utm_content=DAE9rmT2XhE&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton' },
      ],
    },
    {
      title: 'Visual Board Photo Collage',
      category: 'Canva Design',
      description: 'A visually layered collage composition built to highlight imagery, mood, and lifestyle-focused brand aesthetics.',
      image: '/assets/Canva/canva-work-4.png',
      imageLabel: 'Carousel & story layouts',
      links: [
        { label: 'Design 03', href: 'https://www.canva.com/design/DAF6KwlTKUA/4w29msSTRKgaxoXeEK-bUg/edit?utm_content=DAF6KwlTKUA&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton' },
      ],
    },
    {
      title: 'Housing Flyer',
      category: 'Canva Design',
      description: 'A clean promotional flyer layout created to communicate housing details clearly while still feeling polished and branded.',
      image: '/assets/Canva/canva-work-7.png',
      imageLabel: 'Marketing asset collection',
      links: [
        { label: 'Design 04', href: 'https://www.canva.com/design/DAG3q5CM2Bc/7KIfR5BfOFeIQ3HdGaKc0w/edit?utm_content=DAG3q5CM2Bc&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton' },
      ],
    },
    {
      title: 'Intern Housing Flyer',
      category: 'Canva Design',
      description: 'A targeted flyer concept designed for intern housing outreach with strong hierarchy, clarity, and approachable branding.',
      image: '/assets/Canva/canva-work-8.png',
      imageLabel: 'Marketing asset collection',
      links: [
        { label: 'Design 05', href: 'https://www.canva.com/design/DAG-Ubcf_3w/6O-4YiaL15G-gYwubcoRKA/edit?utm_content=DAG-Ubcf_3w&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton' },
      ],
    },
    {
      title: 'Real Estate Newsletter',
      category: 'Canva Design',
      description: 'A newsletter-style design balancing editorial structure, branding, and readable information for real estate marketing needs.',
      image: '/assets/Canva/canva-work-1.png',
      imageLabel: 'Featured Canva design',
      links: [
        { label: 'Design 06', href: 'https://www.canva.com/design/DAFeKQUMr_c/0-iyW11aCqwO8algCZavXw/edit?utm_content=DAFeKQUMr_c&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton' },
      ],
    },
    {
      title: 'Brand Products',
      category: 'Canva Design',
      description: 'A branded product presentation focused on clean composition, strong visual merchandising, and elevated marketing appeal.',
      previewImage: '/assets/Canva/canva-work-2-preview.png',
      image: '/assets/Canva/canva-work-2.png',
      imageLabel: 'Featured Canva design',
      links: [
        { label: 'Design 07', href: 'https://www.canva.com/design/DAHC6T6oVtA/5KDUk3ADmXEP6cQDeHr5wA/edit?utm_content=DAHC6T6oVtA&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton' },
      ],
    },
    {
      title: 'Apartment Listing Graphics',
      category: 'Content System',
      description: 'A reusable listing graphic system built to showcase apartment details in a clear, modern, and engaging format.',
      image: '/assets/Canva/canva-work-6.png',
      imageLabel: 'Carousel & story layouts',
      links: [
        { label: 'Design 08', href: 'https://www.canva.com/design/DAF9jtiMtac/W55CPe_aJnT-sxAMVkIRBg/edit?utm_content=DAF9jtiMtac&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton' },
      ],
    },

    {
      ...
      category: 'Canva Design',
      description: 'A coordinated flyer set designed to support promotions with bold hierarchy, balanced layouts, and branded consistency.',
    ...
    },
    {
      ...
      description: 'A social campaign concept for a clothing brand, combining trend-forward visuals with a cohesive promotional feel.',
    ...
    },
    {
      ...
      category: 'Campaign Design',
      description: 'A story template design intended for fast, on-brand posting with clear messaging and flexible visual structure.',
    ...
    },
    {
      title: 'Story Post Templates',
      category: 'Campaign Design',
      description: 'A companion story template built to extend campaign consistency across social touchpoints with polished visual rhythm.',
  ...
  socialProjects: [
    {
      ...
      links: [
        ...
        { label: 'Video 03', href: 'https://www.tiktok.com/t/ZTkJDYCTR/' },
      ],
      link: 'https://www.tiktok.com/@lexylamparelli?_r=1&_t=ZT-94ssaRIAGYY',
    },
    {
      ...
      links: [
        ...
        { label: 'Video 06', href: 'https://www.tiktok.com/t/ZTkJDAeyN/' },
      ],
      link: 'https://www.tiktok.com/@lexylamparelli?_r=1&_t=ZT-94ssaRIAGYY',
    },
    {
      ...
      links: [
        ...
        { label: 'Video 09', href: 'https://www.tiktok.com/t/ZTkJDFDtN/' },
      ],
      link: 'https://www.instagram.com/lexylamps?igsh=MW00OTR6NG82b2RhOA%3D%3D&utm_source=qr',
    },
  ],
  experience: {
  ...
  socialLinks: [
    { label: 'Email', href: 'mailto:lexylamps222@gmail.com' },
    { label: 'Instagram', href: 'https://www.instagram.com/lexylamps?igsh=MW00OTR6NG82b2RhOA%3D%3D&utm_source=qr' },
    { label: 'TikTok', href: 'https://www.tiktok.com/@lexylamparelli?_r=1&_t=ZT-94ssaRIAGYY' },
    { label: 'Pinterest', href: 'https://pin.it/4b6npcTB5' },
  ],
}
